...
Astro's DX is fantastic, and depending on your use case, you might just want to build your backend on top of it.
...
Depending on your use case, you might opt for Inertia.js to build an interaction-rich SPA app!
