...
But if the above sounds like a dealbreaker, or if you want the freedom to use any backend without fussing around with APIs, Mighty might just fit the bill.
...
Blade is similar to Astro as it is mainly used to build MPAs, and it can perfectly meet your needs, especially when coupled with a light Javascript library like [Alpine.js](https://alpinejs.dev/).
...
Mighty can also be used **_alongside_** Blade, with the abiity to render Astro components inside of your Blade views.
