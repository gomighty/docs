...
To manually setup Mighty, follow the instructions in your desired adapter's page:

- [Laravel manual setup](/guides/backend-adapters/laravel#manual-setup)
- [Hono manual setup](/guides/backend-adapters/hono#manual-setup)
